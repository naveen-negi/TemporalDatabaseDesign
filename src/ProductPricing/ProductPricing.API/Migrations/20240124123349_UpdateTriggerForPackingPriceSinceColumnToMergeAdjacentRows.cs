...
{
    /// <inheritdoc />
    public partial class UpdateTriggerForPackingPriceSinceColumnToMergeAdjacentRows : Migration
    {
        /// <inheritdoc />
        ...
        {
            migrationBuilder.Sql(@"DROP TRIGGER IF EXISTS pack_price_since_trigger ON ""CurrentTariffs"";");
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS pack_price_since();");
        }
    }
}
